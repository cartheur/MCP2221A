namespace Namespace {
    ...
    public static class Module {
        ...
        public static object MCP2221_HID_DELAY = float(os.environ.get("BLINKA_MCP2221_HID_DELAY", 0));
        
        public static object MCP2221_RESET_DELAY = float(os.environ.get("BLINKA_MCP2221_RESET_DELAY", 0.5));
        
        public static object RESP_ERR_NOERR = 0x00;
        
        public static object RESP_ADDR_NACK = 0x25;
        
        public static object RESP_READ_ERR = 0x7F;
        
        public static object RESP_READ_COMPL = 0x55;
        
        public static object RESP_READ_PARTIAL = 0x54;
        
        public static object RESP_I2C_IDLE = 0x00;
        
        public static object RESP_I2C_START_TOUT = 0x12;
        
        public static object RESP_I2C_RSTART_TOUT = 0x17;
        
        public static object RESP_I2C_WRADDRL_TOUT = 0x23;
        
        public static object RESP_I2C_WRADDRL_WSEND = 0x21;
        
        public static object RESP_I2C_WRADDRL_NACK = 0x25;
        
        public static object RESP_I2C_WRDATA_TOUT = 0x44;
        
        public static object RESP_I2C_RDDATA_TOUT = 0x52;
        
        public static object RESP_I2C_STOP_TOUT = 0x62;
        
        public static object RESP_I2C_MOREDATA = 0x43;
        
        public static object RESP_I2C_PARTIALDATA = 0x41;
        
        public static object RESP_I2C_WRITINGNOSTOP = 0x45;
        
        public static object MCP2221_RETRY_MAX = 50;
        
        public static object MCP2221_MAX_I2C_DATA_LEN = 60;
        
        public static object MASK_ADDR_NACK = 0x40;
        
        // MCP2221 Device Class Definition
        public class MCP2221 {
            
            public object VID = 0x04D8;
            
            public object PID = 0x00DD;
            
            public object GP_GPIO = 0b000;
            
            public object GP_DEDICATED = 0b001;
            
            public object GP_ALT0 = 0b010;
            
            public object GP_ALT1 = 0b011;
            
            public object GP_ALT2 = 0b100;
            ...
            public virtual object @__del__() {
                // try to close the device before destroying the instance
                this.close();
            }
            
            // Perform HID Transfer
            public virtual object _hid_xfer(object report, object response = true) {
